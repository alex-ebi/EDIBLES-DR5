...
def main():
    ...
    setting_list = [[860.0, 'redu'],
                    [860.0, 'redl'], [346.0, 'blue'], [437.0, 'blue'], [564.0, 'redl'], [564.0, 'redu'],
                    ]
    ...
    for wave_setting, setting in setting_list:
        ...
        file_dir = edr5_dir / 'EDPS/UVES/flat_860'
        ...
        for file in file_list_start:
            with fits.open(file) as f:
                ...
                if this_wave_setting == wave_setting:
                    ...
                    print(len(flat_list), process.memory_info().rss / 1e9)  # in bytes
        ...
        for file in file_list:
            ...
            print(len(norm_flat_list), process.memory_info().rss / 1e9)  # in bytes
        ...
        for file in bkg_file_list:
            with fits.open(file) as f:
                ...
                print(len(bkg_list), process.memory_info().rss / 1e9)  # in bytes
        ...
        for file in bkg_file_list:
            with fits.open(file) as f:
                ...
                print(len(norm_bkg_list), process.memory_info().rss / 1e9)  # in bytes
