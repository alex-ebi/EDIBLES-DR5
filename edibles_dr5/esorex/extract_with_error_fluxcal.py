...
def main():
    ...
    output_dir_online = Path('/home/Alex/spectra/EDR5/fluxcal')
    ...
    for _, row in obs_list.iterrows():  # Iterate through all OB's
        ...
        # List all reduced merged spectra
            all_reduced_specs = list(sub_dir.glob('fluxcal_science_*'))
            ...
            for red_file in all_reduced_specs:
                ...
                error_file = str(red_file).replace('fluxcal_science_', 'fluxcal_error_science_')
                ...
                ending = red_file.name.replace('fluxcal_science_', '')
